...
export default async (user: User) => {
	...
	const bg = await loadImage(join(__dirname, "../../../extra/res/bbg.jpg"));
    ...
    const yDesc = 100;
	const desc = "Esperamos que te hayas divertido en este server.";
    ctx.fillText(desc, canva.width / 2, canva.height / 2 + yDesc);
